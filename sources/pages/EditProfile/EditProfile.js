...
const EditProfile = ({navigation}) => {
            ...
            // setCashierEmail(getCashierEmail);
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        setCashierId(response.data.logged_in_cashier.cashier_id);
                        setCashierName(response.data.logged_in_cashier.cashier_name);
                        setCashierEmail(response.data.logged_in_cashier.cashier_email);
                })
    ...
    const update = () => {{
        ...
        const editedCashierData = `cashier_name=${dataCashier.cashier_name}&cashier_email=${dataCashier.cashier_email}`;
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.header}>
                    ...
                    <Text style={styles.menuTitle}>Edit Your Profile</Text>
                </View>
            ...
            <TouchableOpacity style={styles.btnUpdateCashier} onPress={() => update()}>
                <Text style={styles.txtUpdateCashier}>Update Your Info</Text>
            </TouchableOpacity>
